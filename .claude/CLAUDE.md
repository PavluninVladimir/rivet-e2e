...
## Codebase Intelligence for rivet-e2e (Repowise)

Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-15 (commit 82ec87f). Confidence: 100%.
...
### Architecture
**Files:** 4 | **Lines:** 79
rivet-e2e is a json codebase of 4 files. Ranked by PageRank over the import graph: the files most of the codebase ultimately depends on. ---
...
- `.github/workflows/e2e.yml` — 3 commits/90d
